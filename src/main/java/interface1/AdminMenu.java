...
public class AdminMenu extends javax.swing.JFrame {
	...
	private void initComponents() {
        ...
        exit.addActionListener(evt -> exitActionPerformed(evt));
        ...
        services2.addActionListener(evt -> servicesActionPerformed(evt));
        ...
        calender2.addActionListener(evt -> calenderActionPerformed(evt));
        ...
        users2.addActionListener(evt -> usersActionPerformed(evt));
        ...
        jButton24.addActionListener(evt -> jButton24ActionPerformed(evt));
...
new SignIn().setVisible(true);
    ...
    private void jButton4ActionPerformed() {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Invalid input. Please select a valid row.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (SQLException ex) {
          
            JOptionPane.showMessageDialog(this, "A database error occurred.", "Error", JOptionPane.ERROR_MESSAGE);
           
            Logger.getLogger(AdminMenu.class.getName()).log(Level.SEVERE, "A database error occurred.", ex);
        } catch (Exception ex) {
          
            JOptionPane.showMessageDialog(this, "An unexpected error occurred.", "Error", JOptionPane.ERROR_MESSAGE);
         
            Logger.getLogger(AdminMenu.class.getName()).log(Level.SEVERE, "An unexpected error occurred.", ex);
        }
    ...
    public javax.swing.JButton users2;
